...
import com.ifchange.tob.common.view.WebConfigurationSupport;
...
public final class RpcReply<T> implements IGeneric<T> {
    ...
    public static class Response<T> {
        ...
        private Response(int errorNo, String errorMSG, T results) {
    ...
    public static final class Helper {
        ...
        private WebConfigurationSupport.GlobalControllerHandler.RpcController.StringRpcQuery query;
        ...
        public void setQuery(WebConfigurationSupport.GlobalControllerHandler.RpcController.StringRpcQuery query) {
            this.query = query;
        }
