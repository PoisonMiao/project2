...
import com.ifchange.tob.common.gearman.lib.impl.reactor.NioReactor;
import com.ifchange.tob.common.gearman.lib.impl.reactor.Socket;
import com.ifchange.tob.common.gearman.lib.impl.reactor.SocketHandler;
	...
	private static final class SocketHandlerImpl<X,Y> implements SocketHandler<SocketHandlerImpl<X,Y>.Connection> {
		...
		private final class Connection implements GearmanConnection<X>, GearmanCodecChannel<Y> {
			...
			public final void onDecode(final GearmanPacket packet) {
				// TODO System.out.println("["+this.getHostAddress()+":"+this.getPort()+"] : IN : "+mysql.getPacketType()); //TODO delete line
