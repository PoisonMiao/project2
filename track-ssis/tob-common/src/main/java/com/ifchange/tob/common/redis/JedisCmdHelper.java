...
public final class JedisCmdHelper {
    ...
    public static RedisOperations createRedisOperations(String uri) {
        ...
        // 哨兵模式
            ...
            return new RedisOperations(JedisCmdHelper.createJedisSentinelPool(info), null);
        }
        // 集群模式
            ...
            throw new RedisException("Redis uri scheme error, please select in [shard | shards | sentinel | cluster | clusters] ");
        }
    }
