...
import com.ifchange.tob.common.esearch.EsearchOutputStream;
...
import com.ifchange.tob.common.rabbit.RabbitOutputStream;
...
class LogbackResetInitializer {
    ...
    void configure() {
        ...
        resetLogLevel("org.springframework");
        resetLogLevel("springfox.documentation.spring");
        // spark log setting
        resetLogLevel("org.apache.spark");
        resetLogLevel("org.spark_project");
        // eclipse log setting
        resetLogLevel("org.eclipse");
        // hikari log setting
        resetLogLevel("com.zaxxer.hikari");
        // jgroups log setting
        resetLogLevel("org.jgroups");
    ...
    private void resetLogLevel(String name) {
