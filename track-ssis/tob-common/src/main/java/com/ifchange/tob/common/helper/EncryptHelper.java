...
public final class EncryptHelper {
    ...
    private static final JwtAlgorithm JWT = new JwtAlgorithm(SALT);
    ...
    public static String signatureJWT(final String tenantNo, final String uid, final String ext, long expireTime) {
        return JWT.signature(tenantNo, uid, ext, expireTime);
    }

    /** 验证授权按签名字段顺序返回 **/
    public static List<String> verifyJWT(String signature) {
        return JWT.verify(signature);
    }
    ...
    private static final class JwtAlgorithm {
        ...
        private final String mixture;
        private JwtAlgorithm(String secret) {
            this.mixture = "@" + secret + "|";
        }
        /** 签名字段， tid, uid, ext, expireTime **/
        private String signature(final String tenantNo, final String uid, final String ext, long expireTime) {
            ...
            return encryptAES(encrypt3DES(sign));
        }
        /** 验证授权按签名字段顺序返回 **/
        private List<String> verify(String signature) {
            ...
            try {
                ...
                String sign = decrypt3DES(decryptAES(signature));
                ...
                for(String rs: data) {
                    if(IConstant.DATA_NONE.equals(rs)) {
        ...
        private List<String> sterilizeData(final String tenantNo, final String uid, final String ext, long expireTime) {
            ...
            return Lists.newArrayList(StringHelper.defaultIfBlank(tenantNo, IConstant.DATA_NONE),
                                      StringHelper.defaultIfBlank(uid, IConstant.DATA_NONE),
                                      StringHelper.defaultIfBlank(ext, IConstant.DATA_NONE),
