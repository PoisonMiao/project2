...
如运行 tob-resume-pdf 项目

mkdir -p /home/${USER}/Documents/deploys/tob-pdf-serve

docker run -d --restart always \
       -p 20000:20000 \
       -v /home/${USER}/Documents/deploys:/mnt \
       --name=tob-pdf-serve \
       --hostname=tob-pdf-serve.001 \
       -e JAR_NAME=tob-pdf-serve \
       -e JAR_ENV=dev \
       -e JAR_URL=http://192.168.1.142/jars/master/tob-pdf-serve.jar \
